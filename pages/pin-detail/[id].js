...
import { deleteCommentQuery, pinDetailMorePinQuery, pinDetailQuery } from '../../utils/data';
  ...
  const handleAddComment = () => {
    ...
    client
      ...
      .insert('after', 'comments[-1]', [{
        createAt: `${getHoursAndMinutes(new Date())} ${getDateWithDayName(new Date())}`,
        comment,
        _key: uuidv4(),
        posted_by: {
          _type: 'posted_by',
        ...
        {!loading && (
          <div className="flex xl:flex-row flex-col m-auto bg-white max-w-[1500px] rounded-[32px] pb-8">
            ...
            <div className="w-full p-5 flex-1 xl:min-w-620">
              ...
              <Link href={`user-profile/${pinDetail?.posted_by._id}`} className="flex gap-2 mt-5 items-center bg-white rounded-lg">
